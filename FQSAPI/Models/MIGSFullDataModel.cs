...
{
    public class MIGSFullDataModel
    {
        ...
        // Mapped from: [Years Membership] (float) -> YearsMembership (C# convention)
        public double YearsMembership { get; set; }

        // Mapped from: YearsMembershipPoints (float)
        public double YearsMembershipPoints { get; set; }

        // Mapped from: [Share Capital] (float) -> ShareCapital (C# convention)
